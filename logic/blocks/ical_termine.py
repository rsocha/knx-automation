...
class ICalTermine(LogicBlock):
    ...
    HELP = """Funktionsweise:
Liest eine iCal-Datei (lokal oder HTTP) und sucht nach bis zu 5 Terminnamen.
Für jeden gefundenen Termin werden Datum, Wochentag, Tage bis zum Termin
und eine Vorwarnung ausgegeben.

Verwendung:
1. iCal-URL an E1 (http://... oder /pfad/zur/datei.ics)
2. Suchbegriffe an E3-E7 (z.B. "Restmüll", "Gelber Sack")
3. Vorwarnzeit in Tagen an E8-E12 (Standard: 1 Tag)
4. E2 = Trigger zum Abrufen
5. Optional: Auto-Trigger über E13 (Uhrzeit) + E14 (Ein/Aus)

Ausgänge pro Slot (5 Slots à 5 Ausgänge):
- Text: Gefundener Terminname
- Vorwarnung: 1 wenn Termin in X Tagen (Vorwarnzeit)
- Nächster Termin: Datum als TT.MM.JJJJ
- Wochentag: Montag-Sonntag
- Tage: Anzahl Tage bis zum Termin

A1 = Summe aller aktiven Vorwarnungen

Versionshistorie:
v2.0 – Eigener iCal-Parser (kein icalendar-Paket nötig), file://-Support, Datumsfix
v1.0 – Erstversion mit icalendar-Bibliothek"""
